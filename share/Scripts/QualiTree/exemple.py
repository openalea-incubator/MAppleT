...
#extract_architecture(mtg_file_path = "F_0.mtg", scene_file_path="F_0.bgeom", nom_arbre = "F_0", date = "1998-05-15", variete = "Fuji", SLA = SLA_fuji, densite_MS_rameaux = Specific_weight, TMS_fruits = TMS_fruits_Fuji, SR = SR, userEllipse=True)
extract_architecture(mtg_file_path = "19.mtg", scene_file_path="19.bgeom", nom_arbre = "F_19", date = "1998-06-30", variete = "Fuji", SLA = SLA_fuji, densite_MS_rameaux = Specific_weight, TMS_fruits = TMS_fruits_Fuji, SR = SR, userEllipse=True)
